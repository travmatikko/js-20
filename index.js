...
Car.prototype.accelerate = function (morespeed) {
...
Car.prototype.brake = function (stopcar) {
  this.speed += stopcar;
  console.log(
...
Truck.prototype.specific = function (truckMaxLoad) {
  if (truckMaxLoad > this.towingCapacity) {
